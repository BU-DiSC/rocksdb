 ...
 public:
  ...
  uint16_t
      compression;  // 1: kNoCompression, 2: kSnappyCompression, 3:
                    ...
                    // kXpressCompression, 8: kZSTD, 9:
                    // kZSTDNotFinalCompression, 10: kDisableCompressionOption
  ...
  uint16_t read_tier;           // 1: kReadAllTier, 2: kBlockCacheTier, 3:
                                // kPersistedTier, 4: kMemtableTier

  // WriteOptions
  bool low_pri;  // every insert is less important than compaction
  bool sync;     // make every write wait: sync with log (so we see real perf
                 // impact of insert)
  bool disableWAL;
